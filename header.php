                    ...
                    <div class="container">
                        <form class="my-2 my-lg-0">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Pesquise aqui" aria-label="Search" aria-describedby="button-addon2">
                                <div class="input-group-append">
                                    <a href="<?php echo home_url(); ?>/wordpress/search-page/">
